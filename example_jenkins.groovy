  ...
  stages {
    ...
    stage('Checkout Source') {
      steps {
        ...
        git credentialsId: 'c52f41f5-4476-4dc6-84aa-9851eb8abef2', url: 'http://gogs-elc-gogs.apps.cluster-99b8.sandbox904.opentlc.com/CICDLabs/openshift-tasks-private.git'
